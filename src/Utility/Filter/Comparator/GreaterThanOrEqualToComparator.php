...
class GreaterThanOrEqualToComparator implements ScalarToScalarComparatorInterface, ArrayToScalarComparatorInterface
{
    /**
     * @inheritDoc
     */
    ...
    {
        if (is_float($actual)) {
            return FloatUtility::isGreaterOrEqual($actual, floatval($testValue));
